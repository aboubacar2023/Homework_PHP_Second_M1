            ...
            <div class="flex flex-col w-64 bg-dark-200 border-r border-dark-300">
                <div class="flex items-center justify-center h-16 px-4 border-b border-dark-300">
                    <div class="flex items-center">
                        <span class="text-xl font-bold">GL - TEAM 2</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <nav class="space-y-1">
                        <a href="/Homework_PHP_Second_M1/views/categories/categorie_index.php"
                            class="sidebar-item <?= str_contains($url, 'categorie') === true ? 'active' : ''  ?>  flex items-center px-4 py-3 rounded-lg">
                            <i class="sidebar-icon fas fa-tags mr-3 text-lg"></i>
                            <span>Catégories</span>
                        </a>
                        <a href="/Homework_PHP_Second_M1/views/articles/article_index.php"
                            class="sidebar-item <?= str_contains($url, 'article') === true ? 'active' : ''  ?> flex items-center px-4 py-3 rounded-lg">
                            <i class="sidebar-icon fas fa-file-alt mr-3 text-lg"></i>
                            <span>Articles</span>
                        </a>
                        <?php if ($user['niveau'] === 'admin') { ?>
                        <a href="/Homework_PHP_Second_M1/views/users/user.php" class="sidebar-item <?= str_contains($url, 'user') === true ? 'active' : ''  ?> flex
                            items-center px-4 py-3 rounded-lg">
                            <i class="sidebar-icon fas fa-users mr-3 text-lg"></i>
